...
<div id="SITE_CONTAINER"><div id="main_MF" class="main_MF"><div id="SCROLL_TO_TOP" class="Vd6aQZ ignore-focus SCROLL_TO_TOP" role="region" tabindex="-1" aria-label="top of page"><span class="mHZSwn">top of page</span></div><button id="SKIP_TO_CONTENT_BTN" class="SKIP_TO_CONTENT_BTN LHrbPP has-custom-focus" tabindex="0">Passer au contenu principal</button><div id="BACKGROUND_GROUP" class="backgroundGroup_gmhiu BACKGROUND_GROUP"><div id="BACKGROUND_GROUP_TRANSITION_GROUP"><div id="pageBackground_gmhiu" data-media-height-override-type="" data-media-position-override="false" class="pageBackground_gmhiu BmZ5pC"><div id="bgLayers_pageBackground_gmhiu" data-hook="bgLayers" data-motion-part="BG_LAYER pageBackground_gmhiu" class="MW5IWV"><div data-testid="colorUnderlay" class="LWbAav Kv1aVt"></div><div id="bgMedia_pageBackground_gmhiu" data-motion-part="BG_MEDIA pageBackground_gmhiu" class="VgO9Yg"></div></div></div></div></div><div id="site-root" class="site-root"><div id="masterPage" class="mesh-layout masterPage css-editing-scope">
    ...
    <div style="max-width: 1200px; margin: 0 auto; padding: 30px 20px 40px 20px;">
      <style>
        ...
        .event-card.inactive .event-image,
        .event-card.inactive .event-image-placeholder {
          filter: grayscale(100%);
        }
        .event-card.inactive .event-content {
          color: #999;
        }
        .event-image {
          width: 100%;
      ...
      <div class="page-header">
        <h1>Événements</h1>
        <p>Découvrez nos événements à venir et passés</p>
        </div>
      ...
      @else
        <div class="event-empty-state">
          <p>Il n'y a actuellement aucun événement disponible. Revenez bientôt pour découvrir de nouveaux événements.</p>
        </div>
      @endif
    </div>
